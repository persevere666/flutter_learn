...
class WebViewFlutterDemo2 extends StatefulWidget {
  const WebViewFlutterDemo2({super.key});

  @override
  State<WebViewFlutterDemo2> createState() => _WebViewFlutterDemo2State();
}

class _WebViewFlutterDemo2State extends State<WebViewFlutterDemo2> {
